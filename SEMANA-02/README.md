...
|---|---|---|---|
| 1 | **[Teoría](1-TEORIA.md)** | Por qué la arquitectura es una decisión económica · Los patrones de presentación MVC, MVP, MVVM y MVI · Clean Architecture aplicada a móviles | Aula · 2 h |
| 2 | **[Dinámica de aula](2-DINAMICA.md)** | El cambio que duele, con su material, su ejemplo resuelto y su rúbrica | Aula · dentro de las 2 h de teoría |
| 3 | **[Taller de laboratorio](3-TALLER.md)** | Esqueleto por capas, decisiones de arquitectura y Definition of Done | Laboratorio · 2 h |
